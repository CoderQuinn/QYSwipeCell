...
class MailTableCell: SwipeTableCell {
    ...
    func initViews() {
        ...
        mailMessage.contentInset = UIEdgeInsets(top: -5, left: -5, bottom: 0, right: 0)
    ...
    override func layoutSubviews() {
        ...
        frame.origin.x = contentView.frame.size.width - leftPadding - dateWidth
